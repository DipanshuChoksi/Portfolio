...
/**
 * Renders a styled input element with default utility classes and forwards native input props.
 *
 ...
 * @param props - Any other native input props are forwarded to the underlying `<input>` element
